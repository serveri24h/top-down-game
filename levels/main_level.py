...
class YSortCameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        self.floor_surface = pygame.image.load('maps/test_map/background2.png').convert()
...
class Level():
    ...
    def create_map(self):
        ...
        layouts = {
            'boundary': h.import_csv_layout('maps/test_map/map_layout_boundaries.csv'),
            'object': h.import_csv_layout('maps/test_map/map_layout_objects.csv'),
            'house': h.import_csv_layout('maps/test_map/map_layout_houses.csv'),
            'entities': h.import_csv_layout('maps/test_map/map_layout_entities.csv')
        }
        ...
        self.player = Player((1410,2993),[self.visible_sprites],self.obstacles_sprites)
    ...
    def run(self):
        ...
        #debug(self.player.status+'_'+self.player.last_direction +' - '+ str(self.player.rect.center)+str(self.player.frame_index))
